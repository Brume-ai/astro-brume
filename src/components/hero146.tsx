...
const Hero146 = () => {
  ...
  return (
    <Fragment>
      <section className="border-muted2 border-b bg-[url(https://deifkwefumgah.cloudfront.net/shadcnblocks/block/patterns/grid-1.svg)] bg-[length:100%_100%] bg-center bg-no-repeat">
          ...
          <div className="flex flex-col items-center gap-5">
            ...
            <div className="pt-6">
              <Button className="block h-fit w-fit animate-shadow-ping rounded-md border border-neutral-950 bg-[linear-gradient(180deg,var(--color-neutral-600),var(--color-neutral-700),var(--color-neutral-900))] px-6 py-3.5 text-center text-lg text-white">
                <a href="#">Créer ma 1ère structure</a>
              </Button>
            </div>
          </div>
