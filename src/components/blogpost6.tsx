...
const AUTHOR: AuthorType = {
  image: vincent.src,
  name: "Vincent Lahaye",
  job: "Fondateur de Brume",
  description:
    "Développeur passionné d'IA, j'ai crée Brume pour aider les marketeurs à produire des contenus par centaines, sans compromis sur la qualité.",
  socials: [
    {
      icon: Linkedin,
      url: "https://www.linkedin.com/in/vincent-lahaye/",
    },
  ],
};
...
const ARTICLE_DURATION = "20 minutes de lecture";

const Blogpost6 = () => {
  const [activeId, setActiveId] = useState<string | null>(null);

  const tocItems = [
    { id: "article-1", text: "ARTICLE 1 : DÉFINITIONS" },
    { id: "article-2", text: "ARTICLE 2 : COMMANDES" },
    { id: "article-3", text: "ARTICLE 3 : ENGAGEMENTS DE BRUME" },
    { id: "article-4", text: "ARTICLE 4 : SERVICES" },
    { id: "article-5", text: "ARTICLE 5 : SUPPORT BRUME" },
    { id: "article-6", text: "ARTICLE 6 : RESPONSABILITÉ" },
    { id: "article-7", text: "ARTICLE 7 : CONDITIONS FINANCIÈRES" },
    { id: "article-8", text: "ARTICLE 8 : RENOUVELLEMENT ET RÉSILIATION" },
    { id: "article-9", text: "ARTICLE 9 : CONFIDENTIALITÉ" },
    { id: "article-10", text: "ARTICLE 10 : DISPOSITIONS GÉNÉRALES" },
    { id: "article-11", text: "ARTICLE 11 : COMPÉTENCE JURIDICTIONNELLE" },
  ];
  ...
  return (
    <section className="pb-32">
      <div className="bg-gradient-to-br from-violet-600 to-black text-white rounded-4xl py-20">
      ...
      <div className="container pt-20">
        <div className="relative mx-auto w-full max-w-5xl items-start justify-between gap-20 lg:flex">
          ...
          <div className="bg-background top-20 flex-1 pb-10 lg:sticky lg:pb-0">
            <div className="text-xl font-medium leading-snug">Sommaire</div>
            <div className="flex flex-col gap-2 pl-2 pt-2">
              {tocItems.map((item) => (
                <a
                  key={item.id}
                  href={`#${item.id}`}
                  className={`text-muted-foreground block text-sm font-medium leading-normal transition duration-300 ${activeId === item.id ? "lg:bg-muted lg:!text-primary lg:rounded-md lg:p-2 lg:font-bold" : "text-muted-foreground"}`}
                >
                  {item.text}
                </a>
              ))}
